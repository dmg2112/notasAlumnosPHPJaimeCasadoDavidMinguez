...
<body>
	<div class="container-fluid">
		<div class="row flex-row">
					...
					foreach ($result as $entry) {
						...
						foreach ($entry['notasAlumno'] as $asig) {
							...
							foreach ($notasAsig as $asig) {
								$num = $asig["numTarea"];
								$nota = $asig["notaTarea"];
								$onClickAction = "document.location.href='./ActualizaNotas.php?tipo=borrar&matricula=" . $matricula . "&tarea=" . $num . "&asignatura=" . $codigoAsig . "'";
			...
			<form class="col-6" method="GET" action="./ActualizaNotas.php">
				Matricula:<br>
